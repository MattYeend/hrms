...
class Logger extends Model
{
    ...
    const ACTION_CREATE_NOTE = 83;
    const ACTION_UPDATE_NOTE = 84;
    const ACTION_DELETE_NOTE = 85;
    const ACTION_SHOW_NOTE = 86;

    const ACTION_CREATE_NOTE_TYPE = 87;
    const ACTION_UPDATE_NOTE_TYPE = 88;
    const ACTION_DELETE_NOTE_TYPE = 89;
    const ACTION_SHOW_NOTE_TYPE = 90;

    const ACTION_CREATE_LANGUAGE = 91;
    const ACTION_UPDATE_LANGUAGE = 92;
    const ACTION_DELETE_LANGUAGE = 93;
    const ACTION_SHOW_LANGUAGE = 94;
    
    const ACTION_CREATE_LEARNING = 95;
    const ACTION_UPDATE_LEARNING = 96;
    const ACTION_DELETE_LEARNING = 97;
    const ACTION_SHOW_LEARNING = 98;

    const ACTION_CREATE_LEARNING_MARKS = 99;
    const ACTION_UPDATE_LEARNING_MARKS = 100;
    const ACTION_DELETE_LEARNING_MARKS = 101;
    const ACTION_SHOW_LEARNING_MARKS = 102;

    const ACTION_CREATE_LEARNING_DIFFICULTY = 103;
    const ACTION_UPDATE_LEARNING_DIFFICULTY = 104;
    const ACTION_DELETE_LEARNING_DIFFICULTY = 105;
    const ACTION_SHOW_LEARNING_DIFFICULTY = 106;

    const ACTION_CREATE_LEARNING_TIME = 107;
    const ACTION_UPDATE_LEARNING_TIME = 108;
    const ACTION_DELETE_LEARNING_TIME = 109;
    const ACTION_SHOW_LEARNING_TIME = 110;

    const ACTION_CREATE_LEARNING_CATEGORY = 111;
    const ACTION_UPDATE_LEARNING_CATEGORY = 112;
    const ACTION_DELETE_LEARNING_CATEGORY = 113;
    const ACTION_SHOW_LEARNING_CATEGORY = 114;

    const ACTION_CREATE_LEARNING_PROVIDER = 115;
    const ACTION_UPDATE_LEARNING_PROVIDER = 116;
    const ACTION_DELETE_LEARNING_PROVIDER = 117;
    const ACTION_SHOW_LEARNING_PROVIDER = 118;

    const ACTION_CREATE_LEARNING_PROVIDER_CONTACT = 119;
    const ACTION_UPDATE_LEARNING_PROVIDER_CONTACT = 120;
    const ACTION_DELETE_LEARNING_PROVIDER_CONTACT = 121;
    const ACTION_SHOW_LEARNING_PROVIDER_CONTACT = 122;

    const ACTION_LEARNING_ASSIGNED = 123;
    const ACTION_LEARNING_STARTED = 124;
    const ACTION_LEARNING_FINISHED = 125;
    const ACTION_LEARNING_ASSIGNED_EMAIL = 126;
    const ACTION_LEARNING_FINISHED_EMAIL = 127;

    const ACTION_CREATE_BLOG = 128;
    const ACTION_UPDATE_BLOG = 129;
    const ACTION_DELETE_BLOG = 130;
    const ACTION_SH0W_BLOG = 131;

    const ACTION_CREATE_BLOG_CATEGORIES = 134;
    const ACTION_UPDATE_BLOG_CATEGORIES = 135;
    const ACTION_DELETE_BLOG_CATEGORIES = 136;
    const ACTION_SH0W_BLOG_CATEGORIES = 137;

    const ACTION_BLOG_LIKE = 138;
    const ACTION_BLOG_COMMENT = 139;

    const ACTION_CREATE_LICENCE = 140;
    const ACTION_UPDATE_LICENCE = 141;
    const ACTION_DELETE_LICENCE = 142;
    const ACTION_SHOW_LICENCE = 143;
    const ACTION_COMPANY_LICENCE_CHANGE = 144;

    const ACTION_CREATE_MEETING = 145;
    const ACTION_UPDATE_MEETING = 146;
    const ACTION_DELETE_MEETING = 147;
    const ACTION_SHOW_MEETING = 148;

    const ACTION_MEETING_MEETING_TYPE_CHANGE = 149;

    const ACTION_CREATE_MEETING_TYPE = 150;
    const ACTION_UPDATE_MEETING_TYPE = 151;
    const ACTION_DELETE_MEETING_TYPE = 152;
    const ACTION_SHOW_MEETING_TYPE = 153;

    const ACTION_CREATE_LOCATION = 154;
    const ACTION_UPDATE_LOCATION = 155;
    const ACTION_DELETE_LOCATION = 156;
    const ACTION_SHOW_LOCATION = 157;
    
    const ACTION_CHANGE_MEETING_LOCATION = 158;
    const ACTION_CHANGE_MEETING_VIRTUAL_TO_PERSON = 159;
    const ACTION_CHANGE_MEETING_PERSON_TO_VIRTUAL = 160;
    ...
    const ACTION_COMPANY_RELATIONSHIP_MANAGER_ASSIGNED_TO_COMPANY = 174;
    const ACTION_COMPANY_RELATIONSHIP_MANAGER_CHANGE_COMPANY_TO_COMPANY = 175;
    const ACTION_COMPANY_RELATIONSHIP_MANAGER_REMOVE_FROM_COMPANY = 176;
